...
active_clients = 0
max_clients = 3
lock = threading.Lock()  # Ensures that active clients isn't incremented until each thread is finished incrementing it, preventing a race condition
...
def start_server():
    ...
    server_socket.bind(('0.0.0.0', 56357))
